  ...
  <view class="page" style="height: calc(100vh + 10px)">
    <view class="container">
      ...
      <view class="find" @click="findProdect('')">
        <u-icon name="search" size="35" class="findIcon"></u-icon>直播名称
      </view>
      <view class="serveList flex mt15">
        <view class="fw600 mr5">热搜</view>
        <view class="serveBtn" @click="findProdect('商业活动')">商业活动</view>
        <view class="serveBtn" @click="findProdect('企业宣传')">企业宣传</view>
        <view class="serveBtn" @click="findProdect('直播带货')">直播带货</view>
        <view class="serveBtn" @click="findProdect('校园')">校园</view>
        <view class="serveBtn" @click="findProdect('婚礼')">婚礼</view>
      </view>
    ...
    <view class="conCenter mt10">
      ...
      <!-- 滚动消息 -->
      <u-notice-bar :list="notList" direction="row" class="mt10"></u-notice-bar>
      <!-- 专家顾问 -->
    ...
    <!-- 推荐直播 -->
    <recommend class="mt10" :name="'推荐直播'" :recomList="recomList" :status="loadStatus"  @reachBottom="reachBottom"></recommend>
    <!-- <u-line class="line" :hair-line="false"></u-line> -->
    <view class="conCenter u-text-center" style="background:#fff;">
...
export default {
  data() {
    return {
      ...
      //滚动通知
      notList: [
        '承接各类活动现场直播:商演活动、开业庆典、企业年会、婚礼现场、毕业典礼等,服务热线：138-8119-5792（微信同号）'
      ],
      find: {
        currentPage: 1, //当前页码
        limit: 10 //每一页的数量
